...
const Dropdown = function() {
  ...
  return (
    <>
    {resumeIsViewed && <Resume resumeToggle={handleClick}/>}
    ...
    <div className="bg-purple-300 h-min w-screen cursor-pointer z-50 absolute group-hover:translate-y-3 group-hover:transition-transform">
      ...
      <span className="hidden group-hover:block text-center text-white text-3xl" onClick={handleClick}>Check out my Resume!</span>
    </div>
